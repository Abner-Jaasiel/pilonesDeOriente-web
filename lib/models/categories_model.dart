...
class CategoriesModel {
  ...
  static List<Map<String, dynamic>> toJsonList(
    ...
    return categoriesList.map((category) {
      try {
        return category.toJson(); // Llama al método toJson para cada categoría
      } catch (e) {
        print("Error al convertir CategoriesModel a JSON: $e");
        return <String,
            dynamic>{}; // Devuelve un mapa vacío con claves String en caso de error
      }
    }).toList();
  }
}
